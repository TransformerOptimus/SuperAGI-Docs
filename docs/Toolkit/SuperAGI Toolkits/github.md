...
1. **Add Files or Folders:** With SuperAGI's GitHub Tool, you can add files or folders to a GitHub repository
2. **Delete Files:** Remove files from a GitHub repository using SuperAGI's GitHub Tool. 
